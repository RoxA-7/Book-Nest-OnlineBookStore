...
- 书单选书、数量统计、总价统计
- 结算时填写收货地址、选择支付方式
- 独立订单号、下单成功弹窗、用户历史订单和订单状态查看
- 支付成功页、订单详情页、订单状态进度展示
- 图书详情页、同分类推荐、浏览历史时间记录
- 图书支持多个分类标签，后台可单独添加分类
- 收藏夹、收藏图书加入书单、历史订单再次购买
- Reading Insights 用户统计和网站统计
- 浅色、深色以及 5 套高级暗色配色主题
- 搜索结果关键词高亮
- 加入书单等轻操作后自动恢复原滚动位置
- 管理员图书增删改查、订单搜索筛选和状态更新
- MySQL 数据库建表和演示数据初始化
